		...
		if OPTIONS.ReadMe then
			save_extra(
				...
				"--[[\n"
					...
					.. "QUICK FIXES:\n"
					.. "• Can't spawn? Move StarterPlayer scripts elsewhere, then run: game:GetService('Players').CharacterAutoLoads = true\n"
					.. "• Chat broken? Run: game:GetService('Chat'):ClearAllChildren() game:GetService('TextChatService'):ClearAllChildren()\n"
					.. "• Camera stuck? Run: workspace.CurrentCamera.CameraType = Enum.CameraType.Fixed\n"
					.. "• Union collisions broken? Run this in Command Bar:\n"
					.. "  for _, v in game:GetDescendants() do\n"
					.. "    if v:IsA('TriangleMeshPart') then v.CollisionFidelity = Enum.CollisionFidelity.Default end\n"
					.. "  end\n\n"
